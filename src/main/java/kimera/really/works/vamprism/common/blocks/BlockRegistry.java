...
public class BlockRegistry
{
    ...
    public static final RegistryObject<Block> SUNLIGHT_POOL = BLOCKS.register("sunlight_pool", () -> new SunlightPoolBlock(AbstractBlock.Properties.create(Material.ROCK).notSolid().setRequiresTool().harvestLevel(2).hardnessAndResistance(2.0F, 4.0F)));
}
